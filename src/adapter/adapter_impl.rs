...
use trustfall::{
    ...
    provider::{
        ...
        ResolveInfo, Typename, VertexIterator, resolve_coercion_using_schema,
...
impl<'a> trustfall::provider::Adapter<'a> for Adapter {
    ...
    fn resolve_starting_vertices(
        ...
        match edge_name.as_ref() {
            "Image" => super::entrypoints::image(resolve_info),
            _ => {
                unreachable!(
    ...
    fn resolve_property<V: AsVertex<Self::Vertex> + 'a>(
        ...
        match type_name.as_ref() {
            "Image" => super::properties::resolve_image_property(
                contexts,
    ...
    fn resolve_neighbors<V: AsVertex<Self::Vertex> + 'a>(
        ...
        match type_name.as_ref() {
            "Image" => super::edges::resolve_image_edge(
                contexts,
                edge_name.as_ref(),
                parameters,
                resolve_info,
